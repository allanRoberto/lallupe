...
set :scm, :git
set :repository,  "git@github.com:allanRoberto/lallupe.git"
# set :scm, :subversion
...
set :local_path, "/Users/Allan/sites/lallupe"
...
set :local_domain, 'lallupe.art.com.br'
